...
function fallbackNarrative(social, price, tvl) {
    const priceText = price.currentPrice === null
        ...
        : `PROS trades at $${price.currentPrice} with ${price.change24hr === null
    ...
    const blockText = tvl.currentTVL === null
        ...
        : `Pharos TVL is $${tvl.currentTVL} with ${tvl.tvlChange24hr ?? 0}% 24 hour TVL change`;
    return {
        narrative: `${priceText}. ${blockText}; CoinGecko lists PROS on ${social.mentionCount} ticker markets and its trending rank is ${social.trendingRank === null ? "unavailable" : `#${social.trendingRank}`}.`,
